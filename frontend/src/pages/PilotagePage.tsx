...
export default function PilotagePage() {
  ...
  return <section className="pilotage-section pilotage-page">
    <div className="pilotage-heading"><div><span className="section-eyebrow">Tableau de bord</span><h2>Vue d’ensemble des projets</h2><p>Consultez rapidement la situation de votre portefeuille de projets.</p></div><button className="primary-action">Créer un projet</button></div>
